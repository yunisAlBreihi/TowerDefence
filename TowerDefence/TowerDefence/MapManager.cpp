...
//void MapManager::CreateTilesFromMap(int mapIndex)
//{
...
//			}
//
//			Tile* tempTile = new Tile(renderer, spriteManager->GetSprite(tempSpriteName), Vector2D(row * GameManager::DEFAULT_SPRITE_SIZE, col * GameManager::DEFAULT_SPRITE_SIZE), Vector2D(GameManager::DEFAULT_SPRITE_SIZE, GameManager::DEFAULT_SPRITE_SIZE), tempWalkable);
